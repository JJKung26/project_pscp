...
import json
import os
from word  import ALL_WORDS  #(แยกไฟล์คลังคำศัพท์)
...
def print_rules():#แสดงกฎกติกา
    ...
    print("\n📊 ระดับความยาก:")
    print("• Easy: ทาย 10 รอบ, เต็ม 5 คะแนน, ใบ้หมวดหมู่ในรอบที่ 5")
    print("• Medium: ทาย 6 รอบ, เต็ม 10 คะแนน, ใบ้หมวดหมู่ในรอบที่ 5 (เสีย 1 คะแนน)")
...
def main():
    ...
    ALL_CATEGORIES = list(ALL_WORDS.keys())#ลิสของหมวดหมู่ทั้งหมด
    ...
    while True:
        ...
        while True:
            ...
            if level in LEVEL_LIST:# เช็คความถูกต้องของระดับความยาก
                ...
                random_word = random.choice(ALL_WORDS[random_category])#สุ่มคำศัพท์จากหมวดหมู่ที่เลือก
                break
            else:
