WORDS_BY_LEVEL = {
        ...
        "objects":   ["TABLE", "CHAIR", "PHONE", "CLOCK", "KNIFE", "PENAL", "GLASS", "PLATE", "RADIO", "SPOON", "BRUSH", "PAPER", "SOFAS"],
        ...
        "food": ["PIZZA", "CANDY", "SALAD", "SUUSHI", "HONEY", "STEAK", "CREAM", "JUICE", "SAUCE", "PASTA", "TOAST", "SUGAR", "WATER", "BREAD"],
        "countrys": ["JAPAN", "CHINA", "INDAI", "EGYPT", "PARIS", "SPAIN", "KOREA", "NEPAL", "DUBAI", "QATRA", "CHILE", "MILAN"],
        "jobs": ["NURSE", "PILOT", "GUARD", "MINER", "ACTOR", "AGENT", "COACH"],
        "sports": ["CHESS", "RUGBY", "SKATE", "SWIMS", "GOLFS", "SAILS"],
        "nature": ["RIVER", "OCEAN", "BEACH", "STORM", "CLOUD", "STONE", "RAINY", "WINDS", "FLAWE", "ROCKS", "MOUNT", "FLORA"],
