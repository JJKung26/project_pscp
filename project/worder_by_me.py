...
def game_play(random_word, random_category, level,point_rate):#ฟังก์ชันเล่นเกม
    ...
    while player_round < round_limit:#ผู้เล่นทายได้ไม่เกิน6ครั้ง
        ...
        print(f'ทายครั้งที่ {player_round}') #โชว์รอบที่ทาย
...
def main():#รอไปก่อนเดี๋ยวมาทำ
    ...
    while True:
        ...
        print(f'คะแนนสะสมของคุณ {username} คือ {total_point * MULTIPLIER[level]} คะแนน ประวัติแพ้/ชนะ:{show_win_lose}')#โชว์คะแนนสะสมและ win lose
